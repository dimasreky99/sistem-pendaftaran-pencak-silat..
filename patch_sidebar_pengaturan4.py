...
pattern = r'<div className="pt-6 px-3 mb-2 text-\[10px\] font-bold text-slate-500 uppercase tracking-widest border-t border-slate-800/40">\s*Pengaturan & Akun\s*</div>.*?Keluar Aplikasi\s*</button>'
