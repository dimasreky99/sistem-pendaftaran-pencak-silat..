...
# 3. Modify the detailed view header to include the toggles
old_header_end = """              <div className="bg-slate-50 border border-slate-200 px-4 py-2.5 rounded-xl text-xs font-semibold text-slate-500 text-right">
                Total: <span className="text-slate-800 font-extrabold">{getFilteredAthletesOfContingent(selectedContingent).length} Atlet</span>
              </div>
            </div>"""

new_header_end = """              <div className="flex items-center gap-3">
...
# 4. Modify the table rendering area to support grid view
old_table = """            {/* Table */}
